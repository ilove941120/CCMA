...
<body>
    ...
    <script>
        ...
        // top按鈕
        var headTop = $(".menuBarBlock").offset().top;
            var anchorPoint1Top = $(".anchorPoint1").offset().top;
            if($(document).scrollTop() > (anchorPoint1Top - headTop)){
                $(".topButton").addClass("topShow");
                // alert("123");
            }
            else{
                $(".topButton").removeClass("topShow");
            }
    </script>
</body>
</html>