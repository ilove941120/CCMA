...
<body>
	<div class="buttonBar">
		...
		<form action="searchTimePage.php" method="POST" class="searchBlock">
			<label for="searchTime">時間搜尋</label>
			<input type="text" id="searchTime" name="searchTime" placeholder="XXXX-XX-XX">
			<input type="submit" valus="送出">
		</form>
	</div>
	...
	while($row_result=$result->fetch_assoc()){
		echo "<div class=\"row\">";
			echo "<div class=\"titleBlock\">";
				...
				echo "<a class=\"button\" href='update.php?id=".$row_result["cID"]."'>刪除</a>";
