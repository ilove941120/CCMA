                ...
                <div class="formBlock">
                    <form action="#" id="askForm" method="POST">
                        ...
                        <div class="formItem">
                            ...
                            <input type="text" id="VisitorName" name="VisitorName" class="inputStyle">
                        </div>
                        <div class="formItem">
                            <label for="VisitorPhone"  class="formTilteStyle">手機</label>
                            <input type="text" id="VisitorPhone" name="VisitorPhone" class="inputStyle">
                        </div>
                        <div class="formItem">
                            <label for="VisitorEmail"  class="formTilteStyle">E-MAIL</label>
                            <input type="email" id="VisitorEmail" name="VisitorEmail" class="inputStyle">
                        </div>
                        <div class="formItem">
    ...
    <script>
        ...
        $(".sentButton").click(function(){
            if($("#VisitorName").val() =="" | chineseNameCheck.test($("#VisitorName").val()) == false){
                $("#VisitorName").addClass("inputWatermark")
                $("#VisitorName").val("名字不符合格式")
            }
            if($("#VisitorPhone").val() =="" | phoneCheck.test($("#VisitorPhone").val()) == false){
                $("#VisitorPhone").addClass("inputWatermark")
                $("#VisitorPhone").val("電話不符合格式")
            }
            if($("#VisitorEmail").val() =="" | emailCheck.test($("#VisitorEmail").val()) == false){
                $("#VisitorEmail").addClass("inputWatermark")
                $("#VisitorEmail").val("信箱不符合格式")
            }
            if($("#askDescription").val() ==""){
                $("#askDescription").addClass("inputWatermark")
                $("#askDescription").val("信箱不符合格式")
                return false;
            }
