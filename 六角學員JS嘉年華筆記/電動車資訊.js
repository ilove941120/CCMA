...
let carData = [{"Kind":"公共充電站","Charge":"免費","Location":"新興區公所 ","Address":" 高雄市新興區中正三路34號1樓(室內停車場)"},
...
carData.forEach(function(item,index){
    ...
    if(item.Charge == "免費"){
        carTotal.free+=1
        newCarData.freeData.push(item)
    }
    else if(item.Charge == "投幣式"){
        carTotal.pay+=1
        newCarData.payData.push(item)
    }
})
console.log(`免費充電站有${carTotal.free}個,付費的有${carTotal.pay}個`)
console.log(newCarData.freeData)
console.log(newCarData.payData)